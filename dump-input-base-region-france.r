...
print(sprintf(names(covariates)))
...
for(Region in names(region_to_country_map))
{
  ...
  stan_data$regions = c(stan_data$regions, Region)

  #print(sprintf('covariates '))
  #print(sprintf(names(covariates1)))
...
print(sprintf("Saving data"))
source_python("Python/src/pickle_data.py")
save_data(stan_data,"model_input_R.pkl")
#save(stan_data, file="model_input.data")
